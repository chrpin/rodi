...
DROP SCHEMA IF EXISTS sigkdd_naive_ci CASCADE;
CREATE SCHEMA sigkdd_naive_ci;
SET search_path = sigkdd_naive_ci, pg_catalog;
...
CREATE TABLE registration_non_member (
    id integer NOT NULL
);
...
COPY registration_non_member (id) FROM stdin;
\.
...
ALTER TABLE ONLY registration_non_member
